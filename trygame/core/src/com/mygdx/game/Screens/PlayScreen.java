...
public class PlayScreen implements Screen {
    // we have to make a constructor as we are sending our screen to render
    ...
    public PlayScreen(TestGame game){
        ...
        j = 0;
        this.game = game;
        this.texture = new Texture("tank_homepage.jfif"); // background image
        ...
        animation = GifDecoder.loadGIFAnimation(Animation.PlayMode.LOOP, Gdx.files.internal("tank1.gif").read());
    }
    @Override
    public void show() {
